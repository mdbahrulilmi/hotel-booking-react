function RoomCard() {
  ...
  const formClick = (index) => {
    window.location.href = `/form/${index}`;
    };

  return (
    <div className="relative pt-2 px-5 overflow-hidden z-0 shadow-lg pb-5 mb-3">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="divide-x divide-gray-300 h-[100px]">
                ...
                <td className="px-3 py-2 text-center">
                  <button className="bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 cursor-pointer" onClick={()=>formClick(1)}>
                    Pilih
                  </button>
                </td>
              </tr>
              <tr className="divide-x divide-gray-300 h-[100px]">
                ...
                <td className="px-3 py-2 text-green-600 font-semibold text-[18px] text-end">Rp 123.123</td>
                <td className="px-3 py-2 text-center">
                  <button className="bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 cursor-pointer" onClick={()=>formClick(2)}>
                    Pilih
                  </button>
                </td>
              </tr>
